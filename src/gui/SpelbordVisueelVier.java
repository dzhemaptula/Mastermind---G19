...
public class SpelbordVisueelVier extends Pane
{
    ...
    public SpelbordVisueelVier(DomeinController dc, HoofdScherm hs)
    {
        ...
        leeg.setFill(javafx.scene.paint.Color.valueOf("#0b2474"));
        ...
        btnPoging.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>()
        {
            ...
            public void handle(MouseEvent event)
            {
                ...
                if (dc.getJuistePogingenAantal() == 4)
                {
                    if(dc.getUitgedaagdeSpeler()==""){}else{
