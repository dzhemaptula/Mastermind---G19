...
public class SpelbordVisueelVijf extends Pane
{

    int poging = 0;
    int[] gegevenCode = new int[]
    {
        0, 0, 0, 0, 0
    };
    ...
    public SpelbordVisueelVijf(DomeinController dc, HoofdScherm hs)
    {
        ...
        btnPoging.setText(Taal.geefString("guiPoging"));
        ...
        btnClear.setText(Taal.geefString("guiClear"));
        ...
        btnSave.setText(Taal.geefString("guiSaveGame"));
        ...
        rood.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>()
        {
            ...
            public void handle(MouseEvent event)
            {
                if (poging == 0)
                {
                    p0.setImage(new Image(getClass().getResource("../imgs2/Rood.png").toExternalForm()));

                } else if (poging == 1)
                {
                    p1.setImage(new Image(getClass().getResource("../imgs2/Rood.png").toExternalForm()));

                } else if (poging == 2)
                {
                    p2.setImage(new Image(getClass().getResource("../imgs2/Rood.png").toExternalForm()));

                } else if (poging == 3)
                {
                    p3.setImage(new Image(getClass().getResource("../imgs2/Rood.png").toExternalForm()));

                } else if (poging == 4)
                {
                    p4.setImage(new Image(getClass().getResource("../imgs2/Rood.png").toExternalForm()));

                }
                gegevenCode[poging] = 1;
                poging++;
            }
        });

        blauw.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>()
        {
            ...
            public void handle(MouseEvent event)
            {
                if (poging == 0)
                {
                    p0.setImage(new Image(getClass().getResource("../imgs2/Blauw.png").toExternalForm()));

                } else if (poging == 1)
                {
                    p1.setImage(new Image(getClass().getResource("../imgs2/Blauw.png").toExternalForm()));

                } else if (poging == 2)
                {
                    p2.setImage(new Image(getClass().getResource("../imgs2/Blauw.png").toExternalForm()));

                } else if (poging == 3)
                {
                    p3.setImage(new Image(getClass().getResource("../imgs2/Blauw.png").toExternalForm()));

                } else if (poging == 4)
                {
                    p4.setImage(new Image(getClass().getResource("../imgs2/Blauw.png").toExternalForm()));

                }
                gegevenCode[poging] = 2;
                poging++;
            }
        });
        geel.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>()
        {
            ...
            public void handle(MouseEvent event)
            {
                if (poging == 0)
                {
                    p0.setImage(new Image(getClass().getResource("../imgs2/Geel.png").toExternalForm()));

                } else if (poging == 1)
                {
                    p1.setImage(new Image(getClass().getResource("../imgs2/Geel.png").toExternalForm()));

                } else if (poging == 2)
                {
                    p2.setImage(new Image(getClass().getResource("../imgs2/Geel.png").toExternalForm()));

                } else if (poging == 3)
                {
                    p3.setImage(new Image(getClass().getResource("../imgs2/Geel.png").toExternalForm()));

                } else if (poging == 4)
                {
                    p4.setImage(new Image(getClass().getResource("../imgs2/Geel.png").toExternalForm()));

                }
                gegevenCode[poging] = 3;
                poging++;
            }
        });
        paars.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>()
        {
            ...
            public void handle(MouseEvent event)
            {
                if (poging == 0)
                {
                    p0.setImage(new Image(getClass().getResource("../imgs2/Paars.png").toExternalForm()));

                } else if (poging == 1)
                {
                    p1.setImage(new Image(getClass().getResource("../imgs2/Paars.png").toExternalForm()));

                } else if (poging == 2)
                {
                    p2.setImage(new Image(getClass().getResource("../imgs2/Paars.png").toExternalForm()));

                } else if (poging == 3)
                {
                    p3.setImage(new Image(getClass().getResource("../imgs2/Paars.png").toExternalForm()));

                } else if (poging == 4)
                {
                    p4.setImage(new Image(getClass().getResource("../imgs2/Paars.png").toExternalForm()));

                }
                gegevenCode[poging] = 4;
                poging++;
            }
        });
        groen.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>()
        {
            ...
            public void handle(MouseEvent event)
            {
                if (poging == 0)
                {
                    p0.setImage(new Image(getClass().getResource("../imgs2/Groen.png").toExternalForm()));

                } else if (poging == 1)
                {
                    p1.setImage(new Image(getClass().getResource("../imgs2/Groen.png").toExternalForm()));

                } else if (poging == 2)
                {
                    p2.setImage(new Image(getClass().getResource("../imgs2/Groen.png").toExternalForm()));

                } else if (poging == 3)
                {
                    p3.setImage(new Image(getClass().getResource("../imgs2/Groen.png").toExternalForm()));

                } else if (poging == 4)
                {
                    p4.setImage(new Image(getClass().getResource("../imgs2/Groen.png").toExternalForm()));

                }
                gegevenCode[poging] = 5;
                poging++;
            }
        });
        cyaan.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>()
        {
            ...
            public void handle(MouseEvent event)
            {
                if (poging == 0)
                {
                    p0.setImage(new Image(getClass().getResource("../imgs2/Cyaan.png").toExternalForm()));

                } else if (poging == 1)
                {
                    p1.setImage(new Image(getClass().getResource("../imgs2/Cyaan.png").toExternalForm()));

                } else if (poging == 2)
                {
                    p2.setImage(new Image(getClass().getResource("../imgs2/Cyaan.png").toExternalForm()));

                } else if (poging == 3)
                {
                    p3.setImage(new Image(getClass().getResource("../imgs2/Cyaan.png").toExternalForm()));

                } else if (poging == 4)
                {
                    p4.setImage(new Image(getClass().getResource("../imgs2/Cyaan.png").toExternalForm()));

                }
                gegevenCode[poging] = 6;
                poging++;
            }
        });
        bruin.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>()
        {
            ...
            public void handle(MouseEvent event)
            {
                if (poging == 0)
                {
                    p0.setImage(new Image(getClass().getResource("../imgs2/Bruin.png").toExternalForm()));

                } else if (poging == 1)
                {
                    p1.setImage(new Image(getClass().getResource("../imgs2/Bruin.png").toExternalForm()));

                } else if (poging == 2)
                {
                    p2.setImage(new Image(getClass().getResource("../imgs2/Bruin.png").toExternalForm()));

                } else if (poging == 3)
                {
                    p3.setImage(new Image(getClass().getResource("../imgs2/Bruin.png").toExternalForm()));

                } else if (poging == 4)
                {
                    p4.setImage(new Image(getClass().getResource("../imgs2/Bruin.png").toExternalForm()));

                }
                gegevenCode[poging] = 7;
                poging++;
            }
        });
        oranje.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>()
        {
            ...
            public void handle(MouseEvent event)
            {
                if (poging == 0)
                {
                    p0.setImage(new Image(getClass().getResource("../imgs2/Oranje.png").toExternalForm()));

                } else if (poging == 1)
                {
                    p1.setImage(new Image(getClass().getResource("../imgs2/Oranje.png").toExternalForm()));

                } else if (poging == 2)
                {
                    p2.setImage(new Image(getClass().getResource("../imgs2/Oranje.png").toExternalForm()));

                } else if (poging == 3)
                {
                    p3.setImage(new Image(getClass().getResource("../imgs2/Oranje.png").toExternalForm()));

                } else if (poging == 4)
                {
                    p4.setImage(new Image(getClass().getResource("../imgs2/Oranje.png").toExternalForm()));

                }
                gegevenCode[poging] = 8;
                poging++;
            }
        });
        leeg.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>()
        {

            @Override
            public void handle(MouseEvent event)
            {
                gegevenCode[poging] = 0;
                poging++;
            }
        });
        btnClear.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>()
        {
            ...
            {
                poging = 0;
                p0.setImage(new Image(getClass().getResource("").toExternalForm()));
                p1.setImage(new Image(getClass().getResource("").toExternalForm()));
                p2.setImage(new Image(getClass().getResource("").toExternalForm()));
                p3.setImage(new Image(getClass().getResource("").toExternalForm()));
                p4.setImage(new Image(getClass().getResource("").toExternalForm()));
                gegevenCode = new int[]
                {
                    0, 0, 0, 0, 0
                };
        ...
        btnSave.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>()
        {
            ...
            public void handle(MouseEvent event)
            {
                try
                {
                    dc.slaSpelOp(txtSpelnaam.getText());
                    hs.toonMenu();
                } catch (IllegalArgumentException e)
                {
                    Alert alert = new Alert(Alert.AlertType.INFORMATION);
                    alert.setContentText(Taal.geefString("naamBestaatAl"));
        ...
        btnPoging.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>()
        {
            ...
            public void handle(MouseEvent event)
            {
                ...
                if (dc.getAantalPogingen() < 12)
                {
                    dc.vergelijkCode(gegevenCode);
                    if (dc.getAantalPogingen() == 0)
                    {
                        if (gegevenCode[0] != 0)
                        {
                            r00.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[0]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[1] != 0)
                        {
                            r01.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[1]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[2] != 0)
                        {
                            r02.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[2]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[3] != 0)
                        {
                            r03.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[3]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[4] != 0)
                        {
                            r04.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[4]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[0] != 0)
                        {
                            v00.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[0]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[1] != 0)
                        {
                            v01.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[1]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[2] != 0)
                        {
                            v02.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[2]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[3] != 0)
                        {
                            v03.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[3]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[4] != 0)
                        {
                            v04.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[4]) + ".png").toExternalForm()));
                        }
                    } else if (dc.getAantalPogingen() == 1)
                    {
                        if (gegevenCode[0] != 0)
                        {
                            r10.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[0]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[1] != 0)
                        {
                            r11.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[1]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[2] != 0)
                        {
                            r12.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[2]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[3] != 0)
                        {
                            r13.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[3]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[4] != 0)
                        {
                            r14.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[4]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[0] != 0)
                        {
                            v10.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[0]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[1] != 0)
                        {
                            v11.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[1]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[2] != 0)
                        {
                            v12.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[2]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[3] != 0)
                        {
                            v13.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[3]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[4] != 0)
                        {
                            v14.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[4]) + ".png").toExternalForm()));
                        }
                    } else if (dc.getAantalPogingen() == 2)
                    {
                        if (gegevenCode[0] != 0)
                        {
                            r20.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[0]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[1] != 0)
                        {
                            r21.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[1]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[2] != 0)
                        {
                            r22.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[2]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[3] != 0)
                        {
                            r23.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[3]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[4] != 0)
                        {
                            r24.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[4]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[0] != 0)
                        {
                            v20.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[0]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[1] != 0)
                        {
                            v21.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[1]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[2] != 0)
                        {
                            v22.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[2]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[3] != 0)
                        {
                            v23.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[3]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[4] != 0)
                        {
                            v24.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[4]) + ".png").toExternalForm()));
                        }
                    } else if (dc.getAantalPogingen() == 3)
                    {
                        if (gegevenCode[0] != 0)
                        {
                            r30.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[0]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[1] != 0)
                        {
                            r31.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[1]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[2] != 0)
                        {
                            r32.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[2]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[3] != 0)
                        {
                            r33.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[3]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[4] != 0)
                        {
                            r34.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[4]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[0] != 0)
                        {
                            v30.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[0]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[1] != 0)
                        {
                            v31.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[1]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[2] != 0)
                        {
                            v32.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[2]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[3] != 0)
                        {
                            v33.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[3]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[4] != 0)
                        {
                            v34.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[4]) + ".png").toExternalForm()));
                        }
                    } else if (dc.getAantalPogingen() == 4)
                    {
                        if (gegevenCode[0] != 0)
                        {
                            r40.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[0]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[1] != 0)
                        {
                            r41.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[1]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[2] != 0)
                        {
                            r42.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[2]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[3] != 0)
                        {
                            r43.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[3]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[4] != 0)
                        {
                            r44.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[4]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[0] != 0)
                        {
                            v40.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[0]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[1] != 0)
                        {
                            v41.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[1]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[2] != 0)
                        {
                            v42.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[2]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[3] != 0)
                        {
                            v43.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[3]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[4] != 0)
                        {
                            v44.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[4]) + ".png").toExternalForm()));
                        }
                    } else if (dc.getAantalPogingen() == 5)
                    {
                        if (gegevenCode[0] != 0)
                        {
                            r50.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[0]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[1] != 0)
                        {
                            r51.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[1]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[2] != 0)
                        {
                            r52.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[2]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[3] != 0)
                        {
                            r53.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[3]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[4] != 0)
                        {
                            r54.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[4]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[0] != 0)
                        {
                            v50.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[0]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[1] != 0)
                        {
                            v51.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[1]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[2] != 0)
                        {
                            v52.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[2]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[3] != 0)
                        {
                            v53.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[3]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[4] != 0)
                        {
                            v54.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[4]) + ".png").toExternalForm()));
                        }
                    } else if (dc.getAantalPogingen() == 6)
                    {
                        if (gegevenCode[0] != 0)
                        {
                            r60.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[0]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[1] != 0)
                        {
                            r61.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[1]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[2] != 0)
                        {
                            r62.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[2]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[3] != 0)
                        {
                            r63.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[3]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[4] != 0)
                        {
                            r64.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[4]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[0] != 0)
                        {
                            v60.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[0]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[1] != 0)
                        {
                            v61.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[1]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[2] != 0)
                        {
                            v62.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[2]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[3] != 0)
                        {
                            v63.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[3]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[4] != 0)
                        {
                            v64.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[4]) + ".png").toExternalForm()));
                        }
                    } else if (dc.getAantalPogingen() == 7)
                    {
                        if (gegevenCode[0] != 0)
                        {
                            r70.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[0]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[1] != 0)
                        {
                            r71.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[1]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[2] != 0)
                        {
                            r72.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[2]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[3] != 0)
                        {
                            r73.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[3]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[4] != 0)
                        {
                            r74.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[4]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[0] != 0)
                        {
                            v70.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[0]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[1] != 0)
                        {
                            v71.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[1]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[2] != 0)
                        {
                            v72.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[2]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[3] != 0)
                        {
                            v73.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[3]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[4] != 0)
                        {
                            v74.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[4]) + ".png").toExternalForm()));
                        }
                    } else if (dc.getAantalPogingen() == 8)
                    {
                        if (gegevenCode[0] != 0)
                        {
                            r80.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[0]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[1] != 0)
                        {
                            r81.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[1]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[2] != 0)
                        {
                            r82.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[2]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[3] != 0)
                        {
                            r83.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[3]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[4] != 0)
                        {
                            r84.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[4]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[0] != 0)
                        {
                            v80.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[0]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[1] != 0)
                        {
                            v81.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[1]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[2] != 0)
                        {
                            v82.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[2]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[3] != 0)
                        {
                            v83.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[3]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[4] != 0)
                        {
                            v84.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[4]) + ".png").toExternalForm()));
                        }
                    } else if (dc.getAantalPogingen() == 9)
                    {
                        if (gegevenCode[0] != 0)
                        {
                            r90.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[0]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[1] != 0)
                        {
                            r91.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[1]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[2] != 0)
                        {
                            r92.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[2]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[3] != 0)
                        {
                            r93.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[3]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[4] != 0)
                        {
                            r94.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[4]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[0] != 0)
                        {
                            v90.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[0]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[1] != 0)
                        {
                            v91.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[1]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[2] != 0)
                        {
                            v92.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[2]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[3] != 0)
                        {
                            v93.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[3]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[4] != 0)
                        {
                            v94.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[4]) + ".png").toExternalForm()));
                        }
                    } else if (dc.getAantalPogingen() == 10)
                    {
                        if (gegevenCode[0] != 0)
                        {
                            r100.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[0]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[1] != 0)
                        {
                            r101.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[1]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[2] != 0)
                        {
                            r102.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[2]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[3] != 0)
                        {
                            r103.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[3]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[4] != 0)
                        {
                            r104.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[4]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[0] != 0)
                        {
                            v100.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[0]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[1] != 0)
                        {
                            v101.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[1]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[2] != 0)
                        {
                            v102.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[2]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[3] != 0)
                        {
                            v103.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[3]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[4] != 0)
                        {
                            v104.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[4]) + ".png").toExternalForm()));
                        }
                    } else if (dc.getAantalPogingen() == 11)
                    {
                        if (gegevenCode[0] != 0)
                        {
                            r110.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[0]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[1] != 0)
                        {
                            r111.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[1]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[2] != 0)
                        {
                            r112.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[2]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[3] != 0)
                        {
                            r113.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[3]) + ".png").toExternalForm()));
                        }
                        if (gegevenCode[4] != 0)
                        {
                            r114.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(gegevenCode[4]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[0] != 0)
                        {
                            v110.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[0]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[1] != 0)
                        {
                            v111.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[1]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[2] != 0)
                        {
                            v112.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[2]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[3] != 0)
                        {
                            v113.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[3]) + ".png").toExternalForm()));
                        }
                        if (dc.getJuistePogingen()[4] != 0)
                        {
                            v114.setImage(new Image(getClass().getResource("../imgs2/" + Kleuren.getKleur(dc.getJuistePogingen()[4]) + ".png").toExternalForm()));
                        }
                    }
                }
                if (dc.getJuistePogingenAantal() == 5)
                {
                    if (dc.getUitgedaagdeSpeler() == "")
                    {
                    } else
                    {
                        dc.gewonnenUitdaging(dc.getSpelerId(dc.getUitgedaagdeSpeler()), dc.getAantalPogingen(), dc.getMoeilijkheidsgraad());
                    }
                    if (dc.getUitdagingstatus())
                    {
                        dc.stopUitdaging();
                        dc.gewonnenGeaccepteerdeUitdaging(dc.getGekozenUitdaging(), dc.getAantalPogingen());
                        if (dc.getAantalPogingen() < dc.getTegenstanderScore(dc.getGekozenUitdaging()))
                        {
                            dc.verhoogWins(dc.getSpelerId(dc.getSpelersNaam()));
                            dc.verlaagLosses(dc.getSpelerId(dc.getSpelersNaam()));
                            dc.verhoogLosses(dc.getTegenStanderIdByUitdagingId(dc.getGekozenUitdaging()));
                            dc.verlaagWins(dc.getTegenStanderIdByUitdagingId(dc.getGekozenUitdaging()));
                        }
                    }
                    dc.gewonnenSpel(dc.getMoeilijkheidsgraad());
                    Alert alert = new Alert(Alert.AlertType.INFORMATION);
                    alert.setContentText(Taal.geefString("guiYouWon"));
                    alert.showAndWait().ifPresent(rs ->
                    {
                        if (rs == ButtonType.OK)
                        {
                ...
                {
                    Alert alert = new Alert(Alert.AlertType.INFORMATION);
                    alert.setContentText(Taal.geefString("guiYouLost"));
                    alert.showAndWait().ifPresent(rs ->
                    {
                        if (rs == ButtonType.OK)
                        {
